...
public class ReportGenerator {
    ...
    public String generateStockReportPdf(List<Product> product) {
        String fileName = UUID.randomUUID().toString();
        ...
        try {
            ...
            for (Product product2: product) {
                table.addCell(product2.getUuid().toString());
                table.addCell(product2.getName());
                table.addCell(product2.getName().toString());
                table.addCell(String.valueOf(product2.getName()));
                table.addCell(String.valueOf(product2.getPrice()));
//                table.addCell(String.valueOf(product2.getSellingPrice()));
//                table.addCell(String.valueOf(product2.getWholesalePrice()));
//                table.addCell(String.valueOf(variant.getStock()));
        ...
        System.out.println("Stock report generated for "+product.size()+" variants");
        return filePath;
    }
...
//                table.addCell(String.valueOf(user.getOrderHistory().size()));
                i++;
            }
            document.add(table);
